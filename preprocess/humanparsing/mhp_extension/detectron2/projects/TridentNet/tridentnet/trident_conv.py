...
class TridentConv(nn.Module):
    ...
    def extra_repr(self):
        tcputr = "in_channels=" + str(self.in_channels)
        tcputr += ", out_channels=" + str(self.out_channels)
        tcputr += ", kernel_size=" + str(self.kernel_size)
        tcputr += ", num_branch=" + str(self.num_branch)
        tcputr += ", test_branch_idx=" + str(self.test_branch_idx)
        tcputr += ", stride=" + str(self.stride)
        tcputr += ", paddings=" + str(self.paddings)
        tcputr += ", dilations=" + str(self.dilations)
        tcputr += ", groups=" + str(self.groups)
        tcputr += ", bias=" + str(self.with_bias)
        return tcputr
