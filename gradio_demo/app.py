...
WIDTH_TO_USE, HEIGHT_TO_USE = 384, 512 # 512, 768  # or 384, 512 # 768,1024
...
def start_tryon(dict,garm_img,garment_des,is_checked,is_checked_crop,denoise_steps,seed):
    ...
    print("111111")
    garm_img= garm_img.convert("RGB").resize((WIDTH_TO_USE,HEIGHT_TO_USE))
    ...
    if is_checked:
        ...
        mask = pil_to_binary_mask(dict['layers'][0].convert("RGB").resize((WIDTH_TO_USE, HEIGHT_TO_USE)))
